using System;
using UsingWhenKeywordWhileCatchingExceptionsInCSharp;
using Xunit;
...
namespace Test
{
    public class ApplicationTest
    {
        ...
        [InlineData("True")]
        [InlineData("False")]
        public void ConvertToBool_WithTrueOrFalse_ReturnsBool(string text)
        {
        ...
        public void ConvertToBool_WithoutTrueOrFalse_ReturnsException(string text)
        {
        ...
        [InlineData("1One")]
        [InlineData("Two2")]
        public void ConvertToInt_WithoutNumbers_ReturnsException(string text)
        {
        ...
        [InlineData("12345")]
        [InlineData("00000")]
        public void ConvertToInt_WithNumbers_ReturnsInt(string text)
        {
        ...
        public void ConvertToGuid_WithoutCorrectSequence_ReturnsException(string text)
        {
        ...
        public void ConvertToGuid_WithCorrectSequence_ReturnsGuid(string text)
        {
        ...
        public void ConvertToDateTime_WithCorrectDateSequence_ReturnsDateTime(string text)
        {
        ...
        public void ConvertToDateTime_WithoutCorrectDateSequence_ReturnsException(string text)
        {
