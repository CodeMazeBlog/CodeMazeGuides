...
public partial class Program
{
    ...
    public static void InitializationDifferences()
    {
        ...
        //equivalent Tuple code
        var InitializedTupleOne = new Tuple<int, int>(1, 2);
        var InitializedTupleTwo = Tuple.Create(1, 2);
        ...
        //Using class based constructors
    ...
    public static void AccessingMemberValues()
    {
        ...
        //Accesing the last parameter of a tuple
        ...
        //Accesing the last parameter of a valueTuple
    ...
    public static void InterConversionOfTuples()
    {
        ...
        //Converting a valueTuple to a tuple: 
    ...
    {
        //Accessing the Decostrucring example
