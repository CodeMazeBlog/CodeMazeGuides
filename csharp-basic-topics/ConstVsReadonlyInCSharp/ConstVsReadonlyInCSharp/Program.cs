...
public class Program
{
    static void Main(string[] args)
    {
        ...
        Console.WriteLine($"A circle with radius 5.59 has a cerconference: {circleCalculator.GetCerconference(5.59)}");
        Console.WriteLine($"Is more accurate estimation of this circle cerconference: {String.Format("{0:0.0000}", circleCalculator.GetAccurateCerconference(5.59))}");
