...
Console.WriteLine(Utilities.PrintList(filteredContainedInts));
Console.WriteLine();
Console.WriteLine("Elements from list 1 that are contained in list 2 - using the simplified method:");
filteredContainedInts = Utilities.FilterContainedUsingWhereSimplified(intsToFilter, filteringIntList);
Console.WriteLine(Utilities.PrintList(filteredContainedInts));
Console.WriteLine();
Console.WriteLine("Elements from list 1 that are not contained in list 2:");
