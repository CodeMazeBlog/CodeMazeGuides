...
public class FloatingPointTypeUnitTest
{
    ...
    public void WhenResultsOfFloatComputationAreCompared_ThenReturnFalse(float firstValue, float secondValue, int factor)   
    {
    ...
    public void WhenResultsOfDoubleComputationAreCompared_ThenReturnFalse(double firstValue, double secondValue, int factor)   
    {
    ...
    public void WhenResultsOfDecimalComputationAreCompared_ThenReturnTrue(decimal firstValue, decimal secondValue, int factor)   
    {
