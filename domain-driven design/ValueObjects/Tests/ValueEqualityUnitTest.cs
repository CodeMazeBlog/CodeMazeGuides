...
{
    [Test]
    public void WhenTwoRecordsWithTheSameData_ThenTheyShouldBeEqual()
    {
    ...
    [Test]
    public void WhenTwoRecordsWithTheDifferentData_ThenTheyShouldNotBeEqual()
    {
        var hundredUsd = Money.Create(100, "USD");
    ...
    [Test]
    public void WhenTwoClassesWithTheSameData_ThenTheyShouldNotBeEqual()
    {
        var hundredUsd = Money.Create(100, "USD");
