...
namespace GenericDeligates
{
  ...
  //public static   int SumReturInt(int x , int y)
    ...
    class Program
    {
        ...
        {
            //First Form before mutation 
            //DelegateVoid objVoid = new DelegateVoid(SumReturVoid);
            //DelegateInt objInt = new DelegateInt(SumReturInt);

            //objVoid.Invoke(10, 20);
            //int result = objInt.Invoke(10, 20);
            //Console.WriteLine("Int return type : " + result);

            //Second Form After mutation 
            //DelegateVoid objVoid = SumReturVoid;
            //DelegateInt  objInt  = SumReturInt;
