...
{
    public class ConvertDateTimeToIso8601StringUnitTest
    {
        DateTime localTime = new DateTime(2022, 1, 13, 16, 25, 35, 125, DateTimeKind.Local);
        DateTime utcTime = new DateTime(2022, 1, 13, 16, 25, 35, 125, DateTimeKind.Utc);
        ...
        public void GivenADateTime_WhenConvertedByTimeZoneLiteral_ThenVerifyIso8601Output()
        {
            ...
            Assert.Equal("2022-01-13T16:25:30", new DateTime(2022, 1, 13, 16, 25, 30, DateTimeKind.Unspecified).ToString(format));
            Assert.Equal("2022-01-13T16:25:30+06:00", new DateTime(2022, 1, 13, 16, 25, 30, DateTimeKind.Local).ToString(format));
            Assert.Equal("2022-01-13T16:25:30Z", new DateTime(2022, 1, 13, 16, 25, 30, DateTimeKind.Utc).ToString(format));
        }
