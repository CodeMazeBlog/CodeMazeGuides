...
int totalMonthsSubscribed = NumberOfMonthsBetweenTwoDates.CalculateSubscriptionDuration(subscriptionStart, currentDate);
Console.WriteLine($"User has been subscribed for {totalMonthsSubscribed} months.");

var courseStart = new DateTime(2023, 9, 12);

double courseDuration = NumberOfMonthsBetweenTwoDates.CalculateCourseDuration(courseStart, currentDate);
