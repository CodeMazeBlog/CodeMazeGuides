...
namespace Tests
{
    ...
    public class Tests 
    {
        ...
        readonly ResourceManager _rmEnglish = new ResourceManager(@"ReadStringFromResourceFile.Resources.Texts.English", typeof(ReadStringFromResourceFile.Resources.Texts.English).Assembly);
