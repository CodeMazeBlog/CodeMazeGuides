...
public class TrimWhitespaceBenchmarks
{
    ...
    private static readonly string SentenceNoLeadingOrTrailingWhitespace = LoremGen.Sentence(10).Trim();
    ...
    private static readonly string LongRandomString = LoremGen.Paragraph(100).Trim();
