...
namespace LogLevelsWithSerilogTests
{
    ...
    public class LogLevelsWithSerilogTests
    {
        ...
        public void Setup()
        {
            ...
            _homeController = new HomeController(_loggerMock.Object, _orderManagerMock.Object);
        }
        ...
        [TestMethod]
        public void WhenIndexRouteCalledWith_ThenCreateOrderMustBeCalled()
        {
            _orderManagerMock.Setup(s => s.CreateOrder(It.IsAny<int>(), It.IsAny<int>())).Verifiable();

            _homeController.Index();

            _orderManagerMock.Verify();
        }
    }
}