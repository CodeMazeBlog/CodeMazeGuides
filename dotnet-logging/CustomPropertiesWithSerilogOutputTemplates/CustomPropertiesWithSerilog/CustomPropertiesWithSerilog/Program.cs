...
Log.Logger = new LoggerConfiguration()
            ...
            .WriteTo.Console(outputTemplate: "{Timestamp:yyyy-MM-dd HH:mm:ss} [{Level:u3}] [{UserId}] {Message:lj}{NewLine}{Exception}")
            .CreateLogger();
...
Log.Logger = new LoggerConfiguration()
    ...
    .WriteTo.Console(outputTemplate: "{Timestamp:yyyy-MM-dd HH:mm:ss} [{Level:u3}] [{Version}] {Message:lj}{NewLine}{Exception}")
    .CreateLogger();
