...
{
    private readonly string _outputPath = @"..\..\..\Image\outputImage.png";
    private readonly string _nullOutputPath = "";
    private readonly string _protectedPath = @"C:\Windows\System32\outputImage.png";
