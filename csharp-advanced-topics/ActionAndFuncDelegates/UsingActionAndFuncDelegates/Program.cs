...
Action<string> greetings = ActionAndFuncDelegates.GreetUser;

greetings("Dave");

//Func delegate

Func<int, string> squaredResult = ActionAndFuncDelegates.SquareToString;

string result = squaredResult(3);
