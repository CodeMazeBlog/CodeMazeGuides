...
{
    public class StockValidationFailureConsumer : ConsumerBase, IHostedService
    {
        private readonly IReceiptGenerator _generator;
        private readonly ILogger<StockValidationFailureConsumer> _logger;

        public StockValidationFailureConsumer(ConnectionFactory connectionFactory,
                                              ILogger<RabbitMqClientBase> rabbitMqClientBaseLogger,
                                              ILogger<ConsumerBase> consumerBaseLogger,                                              
                                              IReceiptGenerator generator,
                                              ILogger<StockValidationFailureConsumer> logger)
