...
public class UTF8LiveTest:IClassFixture<BenchmarkFixture>
{
    ...
    {
        var oldSyntaxReport = _benchmarkReports.FirstOrDefault(report => report.BenchmarkCase.Descriptor.WorkloadMethodDisplayInfo.Contains("OldSyntax"));
        var newSyntaxReport = _benchmarkReports.FirstOrDefault(report => report.BenchmarkCase.Descriptor.WorkloadMethodDisplayInfo.Contains("NewSyntax"));
