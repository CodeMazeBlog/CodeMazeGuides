    ...
    public class Program
    {
        ...
        public void Main(string[] args)
        {
            ...
            switch (strChoice)
            {
                ...
                case "a":
                case "A" :   dArthNum = new ArithMeticProcessing(AddNumber);
                            strOutput = "Addtion";
                            break;

                case "s":
                case "S":   dArthNum = new ArithMeticProcessing(SubNumber);
                            strOutput = "Subtraction";
                            break;

                case "m":
                case "M":   dArthNum = new ArithMeticProcessing(MulNumber);
                            strOutput = "Multipulcation";
                            break;

                case "d":
                case "D":   dArthNum = new ArithMeticProcessing(DivNumber);
                            strOutput = "Division";
                            break;
