...
public class ConvertByteArrayToHexUpperTests
{
    ...
    {
        var result = ConversionHelpers.ToHexStringWithBitConverter(source);
    ...
    public void UsingBitConverter_WhenConvertingAByteArrayAndRemovingDashes_ThenGetCorrectHexString(string expected,
        byte[] source)
    {
        var result = ConversionHelpers.ToHexStringWithBitConverter(source, true);
    ...
    public void UsingStringBuilderAppend_WhenConvertingAByteArray_ThenGetCorrectHexString(string expected,
        byte[] source)
    {
        var result = ConversionHelpers.ToHexStringWithStringBuilderAppend(source);
    ...
    {
        var result = ConversionHelpers.ToHexStringWithBitManipulation(source);
    ...
    {
        var result = ConversionHelpers.ToHexStringWithAlphabetSpanLookup(source);
    ...
    {
        var result = ConversionHelpers.ToHexStringWithLookup(source);
    ...
    public void UsingLookupNetStandard20_WhenConvertingAByteArray_ThenGetCorrectHexString(string expected,
        byte[] source)
    {
        var result = ConversionHelpers.ToHexStringWithLookupNetStandard20(source);
    ...
    {
        var result = ConversionHelpers.ToHexStringWithConvert(source);
