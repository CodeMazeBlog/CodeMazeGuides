...
public class ConvertByteArrayToHexTests
{
    ...
    public void UsingDictionaryLookup_WhenConvertingStringToByteArray_ThenGetCorrectByteArray(string source, byte[] expected)
    {
        var result = ConversionHelpers.FromHexStringWithDictionaryLookup(source);
    ...
    public void UsingBigTableLookup_WhenConvertingStringToByteArray_ThenGetCorrectByteArray(string source, byte[] expected)
    {
        var result = ConversionHelpers.FromHexStringWithBigTableLookup(source);
